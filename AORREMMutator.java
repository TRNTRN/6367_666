...
public enum AORREMMutator implements MethodMutatorFactory {
    ...
    public MethodVisitor create(final MutationContext context,
      ...
      return new RemMethodVisitor(this, methodInfo, context, methodVisitor);
    }
  ...
  class RemMethodVisitor extends AbstractInsnMutator {

    RemMethodVisitor(final MethodMutatorFactory factory,
