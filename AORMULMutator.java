...
public enum AORMULMutator implements MethodMutatorFactory {
    ...
    public MethodVisitor create(final MutationContext context,
      ...
      return new MulMethodVisitor(this, methodInfo, context, methodVisitor);
    }
  ...
  class MulMethodVisitor extends AbstractInsnMutator {

    MulMethodVisitor(final MethodMutatorFactory factory,
