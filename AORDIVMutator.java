...
public enum AORDIVMutator implements MethodMutatorFactory {
      ...
      public MethodVisitor create(final MutationContext context,
        final MethodInfo methodInfo, final MethodVisitor methodVisitor) {
             return new DivMethodVisitor(this, methodInfo, context, methodVisitor);
    }
  ...
  class DivMethodVisitor extends AbstractInsnMutator {

    DivMethodVisitor(final MethodMutatorFactory factory,
