...
public enum AORSUBMutator implements MethodMutatorFactory {
    ...
    public MethodVisitor create(final MutationContext context,
      ...
      return new SubMethodVisitor(this, methodInfo, context, methodVisitor);
    }
  ...
  class SubMethodVisitor extends AbstractInsnMutator {

    SubMethodVisitor(final MethodMutatorFactory factory,
