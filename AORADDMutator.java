...
public enum AORADDMutator implements MethodMutatorFactory {
    ...
    public MethodVisitor create(final MutationContext context,
      ...
      return new AddMethodVisitor(this, methodInfo, context, methodVisitor);
    }
  ...
  class AddMethodVisitor extends AbstractInsnMutator {

    AddMethodVisitor(final MethodMutatorFactory factory,
